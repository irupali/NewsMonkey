  ...
  render() {
    ...
    return (
      <div className="container my-3">
        ...
        <button disabled = {this.state.page + 1 > Math.ceil(this.state.totolResults/this.props.pageSize)} type="button" className="btn btn-dark" onClick={this.handleNextClick}>Next &rarr;</button>
        </div>
      </div>
    );
  }
